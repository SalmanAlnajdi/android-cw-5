...
public class SectionAdapter extends RecyclerView.Adapter {
    ...
    public SectionAdapter(ArrayList<Section> sArray, Context context, LinearLayout linearLayout) {
        this.sArray = sArray;
            ...
            public void onClick(final View v) {
                ...
                builder.setCancelable(false).setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final Section sec = sArray.get(position);
                        sArray.remove(position);
                        notifyDataSetChanged();

                        Snackbar.make(linearLayout,"Student has been deleted",Snackbar.LENGTH_LONG).setAction("Undo", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                sArray.add(sec);
                                notifyDataSetChanged();
